...
export const mockExtendedUsers: ExtendedUser[] = [
  ...
  },
  {
    ...
    permissions: [],
    department: 'Soins',
    position: 'Responsable des soins',
    supervisor: 'user_2',
  ...
  {
    id: 'user_7',
    email: 'pierre.famille@gmail.com',
    firstName: 'Pierre',
    lastName: 'Dupont',
    avatar: '/api/placeholder/40/40',
    ...
    isActive: true,
    lastLogin: new Date('2024-01-13T19:30:00'),
    createdAt: new Date('2024-01-10'),
    updatedAt: new Date('2024-01-13'),
    roles: [mockRoles[6]], // Family
    permissions: [],
    position: 'Fils de Marie Dupont',
    accessLevel: AccessLevel.BASIC,
    canAccessAfterHours: true,
    twoFactorEnabled: false,
    failedLoginAttempts: 0,
  ...
  {
    id: 'user_8',
    email: 'marie.resident@home21.com',
    firstName: 'Marie',
    lastName: 'Dupont',
    avatar: '/api/placeholder/40/40',
    role: UserRole.RESIDENT,
    isActive: true,
    lastLogin: new Date('2024-01-12T16:00:00'),
    createdAt: new Date('2024-01-12'),
    updatedAt: new Date('2024-01-12'),
    roles: [mockRoles[7]], // Resident
    permissions: [],
    accessLevel: AccessLevel.BASIC,
    canAccessAfterHours: false,
    twoFactorEnabled: false,
