      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-secondary-600 text-sm max-w-md">
              A modern SaaS platform built for the future. Streamline your workflow
              and boost productivity with our comprehensive suite of tools.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-secondary-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-secondary-600">
              © {currentYear} Home21. All rights reserved.
            </p>
            <p className="text-sm text-secondary-600 mt-2 md:mt-0">
